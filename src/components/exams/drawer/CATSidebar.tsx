...
import CATExamDrawerContent from "./CATexamDrawerContent";
...
function CATSidebar({
  ...
  return (
    <div className={cn("relative h-screen", showSidebar ? "md:w-[350px]" : "")}>
      ...
      <div
        className={cn(
          "hidden pt-5 md:pt-0  w-full border-l-2 border-gray-700 h-screen overflow-y-clip",
          showSidebar ? "md:block" : "hidden"
        )}
      >
        <CATExamDrawerContent
